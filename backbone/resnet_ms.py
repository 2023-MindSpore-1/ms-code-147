...
model_urls = {
    "resnet50": "./LoadPretrainedModel/resnet50_ascend_v150_imagenet2012_official_cv_top1acc76.97_top5acc93.44.ckpt"
}
net_name = "resnet50"
optimizer = "Momentum"
...
class ResidualBlock(nn.Cell):
    ...
    def __init__(self,
        ...
        if  optimizer == "Thor" or  net_name == "resnet152":
...
class ResNet(nn.Cell):
    ...
    def construct(self, x):
        ...
        return out_1, c2, c3, c4, c5


def resnet50(pretrained=False, class_num=1001):
    """
    ...
    if pretrained:
        ...
        # load checkpoint
        param_dict = load_checkpoint(model_urls["resnet50"])
...
if __name__ == '__main__':
    x = ms.Tensor(np.ones([1,3,256, 256]).astype(np.float32))
